...
export type AvaliacaoPayload = {
  ...
  natacao_50m_livre: number | null
  natacao_100m_livre: number | null
  natacao_200m_livre: number | null
  natacao_400m_livre: number | null
  natacao_800m_livre: number | null
  natacao_1500m_livre: number | null
  natacao_50m_estilo: number | null
  natacao_100m_estilo: number | null
